...
uses
  bpg_common, bpg_bits, bpg_cabac, bpg_cabac_enc, bpg_hevc_defs, bpg_hevcdsp, bpg_scan;
...
// CU_CHROMA_QP_OFFSET_IDX constants. Exported so the encoder in bpg_syntax_enc
