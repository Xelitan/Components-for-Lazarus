...
uses
  Math, bpg_common, bpg_putbits, bpg_hevc_defs, bpg_frame, bpg_cabac_enc, bpg_syntax_enc,
  bpg_hevc_filter;
...
var
  ...
  begin
    ...
    // bpg_enc. Weighting chroma here for the RGB metric was tried both ways and
