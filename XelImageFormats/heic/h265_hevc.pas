...
uses
  SysUtils, h265_common, h265_bits, h265_cabac, h265_hevc_defs, h265_scan, h265_frame,
  h265_hevc_ps, h265_hevcdsp, h265_hevcmc, h265_hevcpred, h265_hevc_cabac,
  h265_hevc_refs, h265_hevc_sei, h265_hevc_mvs, h265_hevc_filter;
...
begin
  ...
  // allocates them per frame in h265_hevc_refs.alloc_frame instead
  Exit(0);
...
// Shared by the decoder below and by the encoder in h265_enc.
procedure luma_intra_candidates(S: PHEVCContext; X0, Y0: Integer;
  out candidate: TIntraCandidates);
var
  LC: PHEVCLocalContext;
