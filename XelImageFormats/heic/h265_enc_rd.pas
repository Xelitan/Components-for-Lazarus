...
//
// The measurement that motivated this (README): at qp 24 a smooth picture is
...
// both.
//
// Installing enc_quadtree_hook replaces the plain walk in h265_enc, so the two
...
uses
  Math, h265_common, h265_hevc_defs, h265_putbits, h265_syntax_enc, h265_enc,
  h265_enc_trial;

// Installs (or removes) the rate-distortion quadtree.
procedure h265_enc_rd_enable(On_: Boolean);
...
function block_ssd(var Enc: TH265Encoder; X0, Y0, Size: Integer): Int64;
var
  S: PHEVCContext;
...
function code_split(var Enc: TH265Encoder;
  X0, Y0, Log2CbSize, CbDepth: Integer; WriteFlag: Boolean): Integer;
var
  S: PHEVCContext;
...
function rd_tu_split(var Enc: TH265Encoder;
...
function rd_cu_part(var Enc: TH265Encoder; X0, Y0, Log2CbSize: Integer): Boolean;
var
  T: TEncTrial;
  Cost2, CostN: Double;
  Size: Integer;
...
function rd_quadtree_entry(var Enc: TH265Encoder;
  X0, Y0, Log2CbSize, CbDepth: Integer): Integer;
var
  S: PHEVCContext;
begin
